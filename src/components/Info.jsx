        ...
        <div className={isDesktop ? "info" : "info_mobile"} id="info">
            <div className={isDesktop ? "info_card_div" : "info_card_div_mobile"}>
                <div className={isDesktop ? "info_card_left" : "info_card_left_mobile"}>
                    ...
                    <hr></hr>
                    <h4>The compression algorithm relies on bitpacking, quantization, as well as discrete cosine transformations. Briefly speaking, a ppm (P6) image is read in and processed, and information not easily discernable by the naked eye is discard. Nearing the end of compression, what info remains about a single pixel is packed into 4 bytes instead of, say, 8-12 bytes. So that's quite a lot of space saved!
                    </h4>
                    <br></br>
